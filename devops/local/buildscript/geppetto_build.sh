...
APPLICATION='/ticketsampleapplication2152'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication2152-desktop:1.0'
...
helm install --name ticketsampleapplication2152-5197 ./helm
if [ $? -eq 0 ]; then
